...
public class SoftScanner extends Activity {

    private static final String  TAG = "SoftScanner";
    ...
    private void displayImage(Mat image)
    {
        ...
        ImageView iv = (ImageView) findViewById(R.id.SSImageView);
...
//			displayImage(sampledImage);
        ...
        else if(id==R.id.action_flexscan)
        {
            ...
            Imgproc.approxPolyDP(cornersMat, approxConrers, 4, true);
