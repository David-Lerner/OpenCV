...
public class ImageBrightness extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {

    private static final String TAG = "ImageBrightness";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "layout: "+R.layout.activity_image_brightness);
        setContentView(R.layout.activity_image_brightness);
        initViews();

        Button mBtGoBack = (Button) findViewById(R.id.bt_go_back);
