...
public class CameraCalibrationActivity extends Activity implements CvCameraViewListener2, OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, JavaCameraView.class+" layout: "+R.layout.camera_calibration_surface_view);
        ...
        mOpenCvCameraView.setLayoutParams(new LinearLayout.LayoutParams(
                ...
                LinearLayout.LayoutParams.MATCH_PARENT));
        LinearLayout myLayout = (LinearLayout) findViewById(R.id.camera_calibration_linear_layout_view);
